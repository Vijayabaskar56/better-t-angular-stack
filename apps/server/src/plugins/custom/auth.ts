...
export const auth = (fastify: EnhancedFastifyInstance) => betterAuth({
 ...
 user: {
  changeEmail: {
   ...
   sendChangeEmailVerification: async (
    ...
    await fastify.sendEmail(getParams);
   }
  },
  deleteUser: {
   enabled: true,
...
async function authPlugin(fastify: EnhancedFastifyInstance) {
